...
KUBELET_GIT_VERSION=v1.36.3+7b29fb0
CONTAINERD_GIT_VERSION=v1.7.33
...
.PHONY: kube-proxy
kube-proxy:
	KUBE_GIT_VERSION=$(KUBELET_GIT_VERSION) KUBE_BUILD_PLATFORMS=windows/amd64 make -C kubelet WHAT=cmd/kube-proxy
